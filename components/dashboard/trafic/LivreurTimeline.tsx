...
export function LivreurTimeline({ livreurs, handleCourierSelect }: LivreursListProps) {
    ...
    return (
        <div className="w-full mx-auto mt-8">
            <h2 className="lg:text-xl font-bold text-primary mb-4">Livreurs Connectés</h2>
