...
import { IconCheck, IconLoaderQuarter } from "@tabler/icons-react";
            ...
            >
              ...
              >
                ...
                {isLoading && id === price.id && (
                  <IconLoaderQuarter className="mr-2 h-4 w-4 animate-spin" />
                )}
              </Button>
              ...
              {price.features && price.features.length > 0 && (
                <ul className="flex flex-col gap-2 font-normal">
                  {price.features.map((feature: any, idx: any) => (
                    ...
                    >
                      <IconCheck className="h-5 w-5 shrink-0 rounded-full bg-green-400 p-[2px] text-black dark:text-white" />
