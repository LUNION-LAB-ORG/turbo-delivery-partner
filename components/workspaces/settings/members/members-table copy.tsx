...
export default function MembersTableCopy() {
        ...
        return (
            <div className="py-2 px-2 flex gap-4 justify-between items-center">
                <Pagination
                    ...
                    onChange={setPage}
                />
                <span className="text-small text-default-400">{selectedKeys === 'all' ? 'Tous les éléments selectionnés' : `${selectedKeys.size} sur ${items.length} selectionné`}</span>
            </div>
        );
