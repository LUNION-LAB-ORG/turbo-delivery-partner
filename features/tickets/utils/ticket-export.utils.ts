...
import { formatDateFR, formatHoursMinutes } from '@/utils/date.utils';
...
export function generatePdfTemplate(tickets: BonLivraisonTerminee[]): string {
...
<div class="stats">
    ...
    <p>
        <strong>Montant total des livraisons :</strong> ${formatCurrency(totalLivraison)} CFA
    </p>
    <p>
        <strong>Montant total des commissions :</strong> ${formatCurrency(totalCommission)} CFA
    </p>
    <p><strong>Revenu total:</strong> ${formatCurrency(totalRevenu)} CFA</p>
</div>
<table>
    <thead>
    <tr>
...
export function generateXlsTickets(tickets: BonLivraisonTerminee[]) {
