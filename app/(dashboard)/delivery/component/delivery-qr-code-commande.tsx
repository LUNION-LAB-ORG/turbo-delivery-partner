...
import { CommandeCourseExterne, Restaurant, CourseExterne } from '@/types/models';
                            ...
                            <DialogPanel className="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                ...
                                <div className="flex flex-col items-center gap-6 p-8">
                                    ...
                                    <div className="text-center">
                                        <p className="text-lg font-medium mb-2">N° Commande: {commande.numero}</p>
                                        <p className="text-gray-500 dark:text-gray-400">Code de la Course: {delivery.code}</p>
                                        <p className="text-gray-500 dark:text-gray-400">Restaurant: {restaurant.nomEtablissement}</p>
                                    </div>
                                    <button type="button" className="btn btn-primary mt-4" onClick={() => setOpen(false)}>Fermer</button>
                                </div>
                            </DialogPanel>
                        </TransitionChild>
                    </div>
...
export default DeliveryQRCodeCommande;